				...
				<div class="col-lg-6 my-5 py-2">
					<div class="card">
						<div
							...
							<p class="mb-0 small">
								Não está cadastrado? <a href="register.html" class="cyan-text">Cadastre-se
									já</a>
							</p>
						</div>
							...
							<form class="text-center" style="color: #757575;" method="POST"
								...
								<div class="md-form">
									<input type="email" id="txtEmail" name="txtEmail"
										class="form-control"> <label for="txtEmail">E-mail</label>
								</div>
								<div class="md-form">
									<input type="password" id="txtSenha" name="txtSenha"
										class="form-control"> <label for="txtSenha">Senha</label>
								</div>
