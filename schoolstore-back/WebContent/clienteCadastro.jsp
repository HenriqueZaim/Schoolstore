				...
				<form method="post" action="app" id="clienteFormulario">
					<div class="row justify-content-center">
						<div class="col-md-10">
							...
							<div class="form-row">
								<div class="col mb-3 md-form">
									<label for="txtNome">Nome Completo*</label> <input type="text"
										class="form-control" id="txtNome" name="txtNome" required
							...
							<div class="form-row">
								<div class="col mb-3 md-form">
									<label for="txtNumeroDocumento">CPF/CNPJ*</label> <input
										type="text" class="form-control" name="txtNumeroDocumento"
										id="txtNumeroDocumento" required maxlength="14">
									<div class="valid-feedback">Documento válido!</div>
									<div class="invalid-feedback">Campo inválido</div>
								</div>
								<div class="col mb-3 md-form">
									<label for="txtNumeroTelefone">Número de Telefone*</label> <input
										type="text" class="form-control" name="txtNumeroTelefone"
							...
							<div class="form-row">
								<div class="col mb-3 md-form">
									<label for="txtSenha">Senha*</label> <input type="password"
										maxlength="100" class="form-control" name="txtSenha"
										id="txtSenha" required>
								...
								<div class="col mb-3 md-form">
									...
									<input type="password" maxlength="100" class="form-control"
										id="txtConfirmacaoSenha" required>
			...
			<div class="modal-content">
				...
				<div class="modal-body mx-3">
					...
					<div class="form-row">
						...
						<div class="col-md-6 mb-3 md-form">
							<select style="width: 100%;" id="txtCidadeModal" required
