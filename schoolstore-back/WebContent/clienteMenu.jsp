                        ...
                        <div class="col-md-4">
                          <div class="card">
                            ...
                            <div class="card-footer text-right teal darken-1">
                              <form action="" method="">
                                <!-- inputs aqui -->
                                <button type="submit" class="btn btn-link p-0 text-white font-weight-bold" >Visualizar Cupons</button>
                              </form> 
                            </div>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="card">
                            ...
                            <div class="card-footer text-right teal darken-1">
                              <form action="" method="">
                                <!-- inputs aqui -->
                                <button type="submit" class="btn btn-link p-0 text-white font-weight-bold" >Visualizar Pedidos</button>
                              </form> 
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4">
                          <div class="card">
                            ...
                            <div class="card-footer text-right green darken-1">
                              <form action="" method="">
                                <!-- inputs aqui -->
                                <button type="submit" class="btn btn-link p-0 text-white font-weight-bold" >Visualizar Produtos</button>
                              </form> 
                            </div>
                          </div>
                        </div>
