			...
			<div class="sidebar-fixed position-fixed">
				...
				<div class="list-group list-group-flush mt-5">
					...
					<a href="trocaLista.jsp" class="list-group-item list-group-item-action waves-effect"> <i class="fas fa-exchange-alt mr-3"></i>Minhas Trocas
						...
						<a href="cupomLista.jsp" class="list-group-item list-group-item-action waves-effect"> <i class="fas fa-ticket-alt mr-3"></i>Meus Cupons
						</a>
					<form action="app" method="POST">
						<input type="hidden" name="txtUsuarioId" value="${usuario.getId()}"> <input type="hidden" name="txtClienteId" value="${cliente.getId()}"> <input type="hidden" name="txtImagemId" value="${usuario.getImagem().getId()}"> <input type="hidden" name="tarefa" value="editaCliente">
						<button type="submit" class="list-group-item list-group-item-action waves-effect">
		...
		<div class="container-fluid mt-5">
			<div class="card mb-4 wow fadeIn">
				<div class="card-body d-sm-flex justify-content-between">
					<h1 class="mb-2 mb-sm-0 pt-1">Cancelamento de Pedido</h1>
				</div>
			</div>
								...
								<table class="table product-table mb-0">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-right">
												<input type="hidden" name="txtValor" id="subTotal" value="${pedido.getValor() - pedido.getFrete().getValor() }">
												<h4 class="mt-2" id="valorTotalCompra"></h4></td>
											<td colspan="3" class="text-right">
												<input type="hidden" name="tarefa" value="efetuarCancelamento">
												...
												<c:forEach var="cupom" items="${pedido.getFormaPagamento().getPagamentosCupom() }">
													<input type="hidden" name="txtCupomId" value="${cupom.getId()}">
												</c:forEach>

												<button type="submit" class="btn btn-primary btn-rounded">
													Completar Cancelamento<i class="fas fa-angle-right right"></i>
												</button>
											</td>
										</tr>
