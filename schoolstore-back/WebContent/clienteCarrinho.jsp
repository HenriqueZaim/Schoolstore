											...
											<tbody>
												<c:forEach var="item" items="${carrinho.getItensCarrinho()}">
													<tr>
														...
														<td class="preco">R$${ (Math.round( ( (item.getProduto().getPreco() * item.getProduto().getPrecificacao().getPercentual()) * item.getQuantidade() + item.getProduto().getPreco())) * 100) / 100}</td>
